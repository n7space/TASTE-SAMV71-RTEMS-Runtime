...
/**
 * @brief                       Informs the monitor about given interface
 * activation, monitor stores timestamp of activation in specific configurable
 * memory location.
 *
...
/**
 * @brief                       Informs the monitor about given interface
 * deactivation, monitor stores timestamp of deactivation in specific
...
/**
 * @brief                                           Provides access to optional
 * interface activation log.
 *
 * @param[in] activation_log                        pointer pointing to
 * beginning of cyclic buffer holding all activation entries
 * @param[in] out_latest_activation_entry_index     representing latest
 * activation log index
 * @param[in] out_size_of_activation_log            representing size of
 * activation log
 *
 * @return                                          Bool indicating whether the
...
/**
 * @brief                       Stops storing of interface activation logs, all
 * activation logs are lost after this operation
 *
 * @return                      Bool indicating whether the freeze was
 * successful
 */
 ...
 *
 * @return                      Bool indicating whether the unfreeze was
 * successful
 */
bool Monitor_UnfreezeInterfaceActivationLogging();

/**
 * @brief                       Clears all interface activation logs, resets
 * latest_activation_entry_index and size_of_activation_log
 *
